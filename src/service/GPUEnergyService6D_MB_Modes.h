/*
 * GPU_6D_MB_EnergyService.h
 *
 *  Created on: Sep 8, 2016
 *      Author: uwe
 */

#ifndef SRC_SERVICE_GPUENERGYSERVICE6D_MB_MODES_H_
#define SRC_SERVICE_GPUENERGYSERVICE6D_MB_MODES_H_
...
public:
	...
	using configurator_t = Configurator_6D_MB_Modes<REAL>;
	...
	explicit GPUEnergyService6D_MB_Modes(std::shared_ptr<DataManager> dataMng, std::vector<int> const& deviceIds);
	virtual ~GPUEnergyService6D_MB_Modes() {};
...
#endif /* SRC_SERVICE_GPUENERGYSERVICE6D_MB_MODES_H_ */
