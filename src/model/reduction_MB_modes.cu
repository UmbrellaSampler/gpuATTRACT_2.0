...
__global__ void
blockReduceMode(unsigned numAtomsRec, unsigned numAtomsLig, unsigned numModesRec, unsigned numModesLig,  DOF_6D_MB_Modes<T>* dofs, unsigned int ligIdx,
		...
		T *g_odata)
{
    ...
    Vec3<T> const& ang = dof._6D[ligIdx].ang;
...
//	if (isPow2(max(numAtomsRec, numAtomsLig)))
		if (isPow2( numAtomsLig))
	{
		...
		{
			case 1024:
				blockReduceMode<T, 1024,true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 512:
				blockReduceMode<T, 512, true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 256:
				blockReduceMode<T, 256, true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 128:
				blockReduceMode<T, 128, true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 64:
				blockReduceMode<T,  64, true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 32:
				blockReduceMode<T,  32, true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 16:
				blockReduceMode<T,  16, true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case  8:
				blockReduceMode<T,   8, true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case  4:
				blockReduceMode<T,   4, true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case  2:
				blockReduceMode<T,   2, true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case  1:
				blockReduceMode<T,   1, true><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec, numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;
		}
	}
	else
	{
		...
		{
			case 1024:
				blockReduceMode<T, 1024,false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 512:
				blockReduceMode<T, 512, false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 256:
				blockReduceMode<T, 256, false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 128:
				blockReduceMode<T, 128, false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 64:
				blockReduceMode<T,  64, false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 32:
				blockReduceMode<T,  32, false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case 16:
				blockReduceMode<T,  16, false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case  8:
				blockReduceMode<T,   8, false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec, d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case  4:
				blockReduceMode<T,   4, false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec,d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case  2:
				blockReduceMode<T,   2, false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec,d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;

			case  1:
				blockReduceMode<T,   1, false><<< dimGrid, dimBlock, smemSize, stream >>>(numAtomsRec, numAtomsLig, numModesRec,  numModesLig, dofs, ligIdx, xPos, yPos, zPos, xModesRec, yModesRec, zModesRec,  xModesLig, yModesLig, zModesLig, d_fxRec, d_fyRec, d_fzRec,d_fxLig, d_fyLig, d_fzLig, d_E, g_odata);
				break;
		}
	}
