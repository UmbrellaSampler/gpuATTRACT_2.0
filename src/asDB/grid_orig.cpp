...
void attract::Grid::init(double gridspacing0, int gridextension0, double plateaudis0,
...
#ifdef TORQUEGRID
void attract::Grid::read_torque(const char *filename) {
#else
void attract::Grid::read_std(const char *filename) {
#endif
	int n;
...
#ifdef TORQUEGRID
void attract::Grid::write_torque(const char *filename) {
#else
void attract::Grid::write_std(const char *filename) {
#endif
	long n;
