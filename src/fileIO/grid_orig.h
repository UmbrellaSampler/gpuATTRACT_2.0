...
struct Grid {
  ...
  EnerGradStd *energrads_std = nullptr;
  //or this:
  EnerGradTorque *energrads_torque = nullptr;
  ...
  */			    
  ...
  double *_ratio  = nullptr; /*precomputed ratios to scale down distances, to reach 5 A*/
